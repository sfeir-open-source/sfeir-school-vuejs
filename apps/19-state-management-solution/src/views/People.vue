<template>
  <section class="search-container">
    <div class="search">
      <Search v-model="peopleStore.peopleState.search" />
    </div>
  </section>
  <section class="container">
    <Card v-for="person in peopleStore.people" :key="person.id" :person="person" @delete-person="peopleStore.deletePerson" />
