  ...
  render(Form, {
    ...
    global: {
      stubs: {
        ...
        'a-input': {
          inheritAttrs: false,
          props: ['value', 'modelValue', 'placeholder', 'name'],
          emits: ['update:value', 'update:modelValue'],
          template:
            '<input v-bind="$attrs" :name="name" :value="modelValue ?? value" :placeholder="placeholder" @input="$emit(\'update:value\', $event.target.value); $emit(\'update:modelValue\', $event.target.value)" />',
        },
        'a-button': {
          props: ['disabled'],
          emits: ['click'],
...
describe('Form.vue', () => {
  ...
  it('keeps save disabled and does not emit payload when the form is invalid', async () => {
