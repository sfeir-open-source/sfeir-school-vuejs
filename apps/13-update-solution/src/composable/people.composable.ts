...
export function usePeople() {
  ...
  const updatePersonById: (personForm: PersonForm) => Promise<void> = async (personForm: PersonForm) => {
    await axios.put<Person>(`${import.meta.env.VITE_BASE_API}/peoples/${personForm.id}`, personForm);
  };
