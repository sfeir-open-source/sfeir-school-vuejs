<template>
  <md-card class="card-panel">
    ...
    <md-card-content>
      ...
      <form @submit="submit">
        <md-input-container
          :class="{ 'md-input-invalid': $v.person.firstname.$error }"
        >
        ...
        <md-input-container
          :class="{ 'md-input-invalid': $v.person.lastname.$error }"
        >
        ...
        <md-input-container
          :class="{ 'md-input-invalid': $v.person.email.$error }"
        >
          <label>Email</label>
          <md-input
          ...
          ></md-input>
          <div class="md-error">
            <span v-show="$v.person.email.$error && !$v.person.email.required"
              >Champs obligatoire</span
            >
            <span v-show="$v.person.email.$error && !$v.person.email.email"
              >Vous devez saisir un mail valide</span
            >
            <span v-show="$v.person.email.$error && !$v.person.email.sfeirmail"
              >Vous devez saisir un mail SFEIR valide (ex:
              chegham.w@sfeir.com)</span
            >
          </div>
        </md-input-container>
        <md-input-container
          :class="{ 'md-input-invalid': $v.person.phone.$error }"
        >
          <label>Phone</label>
          <md-input
          ...
          ></md-input>
          <div class="md-error">
            <span v-show="!$v.person.phone.pattern"
              >Vous devez saisir 10 chiffres</span
            >
          </div>
        </md-input-container>
      </form>
    ...
    <md-card-actions>
      ...
      <md-button @click.prevent="submit" :disabled="$v.person.$invalid"
        >Submit</md-button
      >
    </md-card-actions>
  </md-card>
