      ...
      <form @submit="submit">
        <md-input-container :class="{ 'md-input-invalid': $v.person.firstname.$error }">
          ...
          <div class="md-error">
            ...
            <span
              v-show="$v.person.firstname.required && !$v.person.firstname.maxLength"
        ...
        <md-input-container :class="{ 'md-input-invalid': $v.person.lastname.$error }">
          ...
          <div class="md-error">
            ...
            <span
              v-show="$v.person.lastname.required && !$v.person.lastname.maxLength"
            >Vous devez saisir au moins 2 caractères</span>
          </div>
        </md-input-container>
        <md-input-container :class="{ 'md-input-invalid': $v.person.email.$error }">
          ...
          <div class="md-error">
            ...
            <span
              v-show="$v.person.email.$error && !$v.person.email.email"
            >Vous devez saisir un mail valide</span>
            <span
              v-show="$v.person.email.$error && !$v.person.email.sfeirmail"
            >Vous devez saisir un mail SFEIR valide (ex: chegham.w@sfeir.com)</span>
          </div>
        </md-input-container>
